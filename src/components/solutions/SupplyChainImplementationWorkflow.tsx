    ...
    <div className="space-y-12 relative">
      ...
      <div className="relative pt-6 pb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 items-center relative">
          ...
          {/* Card 01 (Top Left) */}
          <div className="lg:col-span-5 bg-white rounded-3xl p-7 border-2 border-[#266573]/30 shadow-[0_8px_30px_rgba(18,38,49,0.06)] hover:shadow-[0_16px_40px_rgba(18,38,49,0.12)] transition-all relative overflow-hidden group">
            <div className="flex items-center justify-between mb-4">
              <div className="w-12 h-12 rounded-2xl bg-[#122631] text-[#6BB0BF] flex items-center justify-center shadow-md border border-[#266573]/30">
                <Search className="w-6 h-6" />
              </div>
              <span className="font-mono text-3xl font-black text-[#266573]/30 group-hover:text-[#266573] transition-colors">
                #01
              </span>
            </div>

            <span className="text-[10px] font-mono text-[#266573] font-bold uppercase tracking-wider block mb-1">
              PHASE 01 • INTAKE
            </span>
            <h3 className="text-lg font-bold text-[#122631] mb-2 leading-snug">
              Demand Assessment & Consumption Diagnostic
            </h3>
            <p className="text-xs text-[#122631]/70 leading-relaxed mb-4">
            ...
            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[#EDF3F0] text-[11px] font-mono font-bold text-[#122631] border border-[#CAD7D0]">
          ...
          <div className="hidden lg:flex lg:col-span-2 flex-col items-center justify-center space-y-1">
            ...
            <div className="flex items-center w-full">
              <div className="h-0.5 w-full bg-gradient-to-r from-[#266573] to-[#6BB0BF]" />
              <div className="w-3 h-3 border-t-2 border-r-2 border-[#6BB0BF] rotate-45 -ml-2" />
            </div>
          </div>
        ...
        <div className="mt-4 max-w-3xl mx-auto">
          <div className="bg-[#122631] rounded-3xl p-8 text-white shadow-[0_20px_50px_rgba(18,38,49,0.3)] border-2 border-[#266573]/40 relative overflow-hidden text-center space-y-4">
            <div className="pointer-events-none absolute -top-20 left-1/2 -translate-x-1/2 w-96 h-96 bg-[#266573]/30 rounded-full blur-[90px]" />
            
            <div className="relative z-10 flex items-center justify-center gap-2 mb-1">
              <span className="px-3 py-1 rounded-full bg-[#266573]/40 border border-[#6BB0BF]/30 text-[#6BB0BF] text-xs font-mono uppercase tracking-wider font-bold">
                FINAL MILESTONE • #05
              </span>
            </div>
            ...
            <p className="relative z-10 text-xs sm:text-sm text-[#CAD7D0]/85 max-w-xl mx-auto leading-relaxed">
            ...
            <div className="relative z-10 pt-2 flex flex-wrap justify-center gap-3 text-xs font-mono">
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/15 text-emerald-400 font-bold flex items-center gap-1.5">
                <CheckCircle2 className="w-3.5 h-3.5" />
                Zero Stockout Guarantee
              </span>
              <span className="px-3 py-1 rounded-full bg-white/10 border border-white/15 text-[#6BB0BF] font-bold flex items-center gap-1.5">
