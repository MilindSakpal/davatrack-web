...
export function Hero() {
  ...
  return (
    <section
      ref={heroRef}
      className="pt-28 sm:pt-32 pb-8 sm:pb-12 bg-[#EDF3F0] relative overflow-hidden"
    >
      ...
      <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-44 bg-gradient-to-t from-[#EDF3F0] via-[#EDF3F0]/80 to-transparent z-0" />
