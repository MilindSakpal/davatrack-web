  ...
  if (isSubmitted) {
    return (
      <div className="bg-white rounded-3xl p-8 sm:p-12 border border-[#CAD7D0] shadow-[0_4px_20px_rgba(18,38,49,0.04)] text-center space-y-6 max-w-2xl mx-auto">
        <div className="w-16 h-16 rounded-full bg-[#EEF4F3] text-[#266573] flex items-center justify-center mx-auto ring-8 ring-[#CAD7D0]/30">
        ...
        <div className="bg-[#EEF4F3] p-5 rounded-2xl border border-[#CAD7D0] text-left space-y-3 text-xs text-[#122631]/80">
        ...
        <div className="pt-2 flex flex-wrap justify-center gap-4">
          <button
            onClick={handleReset}
            className="px-6 py-2.5 rounded-xl border border-[#CAD7D0] bg-white text-[#122631] font-semibold text-xs hover:bg-[#EEF4F3] transition-colors"
          >
              ...
              <button
                ...
                className={cn(
                  ...
                  isSelected
                    ...
                    : "bg-[#EEF4F3] text-[#122631] hover:bg-[#CAD7D0]/50 border-[#CAD7D0]"
                )}
              >
                {isSelected ? "✓ " : "+ "}
                {interest}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <input
              ...
              className={cn(
                ...
                errors.name
                  ...
                  : "border-[#CAD7D0] bg-[#EEF4F3]/30 focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20"
              )}
            />
          </div>
          {errors.name && (
        ...
        <div className="space-y-1.5">
          ...
          <input
            ...
            className="w-full px-4 py-3 rounded-xl border border-[#CAD7D0] bg-[#EEF4F3]/30 text-sm text-[#122631] outline-none focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20 transition-all placeholder:text-[#122631]/40"
          />
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <select
            ...
            className="w-full px-4 py-3 rounded-xl border border-[#CAD7D0] bg-[#EEF4F3]/30 text-sm text-[#122631] outline-none focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20 transition-all cursor-pointer"
          >
