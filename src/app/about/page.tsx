        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl space-y-6">
            ...
            <div className="pt-2 flex flex-wrap gap-3">
              ...
              <Link
                href="/solutions"
                className="px-7 py-3.5 rounded-full bg-white hover:bg-[#EDF3F0] text-[#122631] font-bold text-sm border border-[#266573]/20 shadow-sm transition-all"
              >
                Explore Solutions
              </Link>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#CAD7D0] shadow-[0_12px_40px_rgba(18,38,49,0.06)] flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="mt-8 pt-6 border-t border-[#CAD7D0]/60">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-2 text-xs font-bold text-[#122631]">
                  <div className="bg-[#EDF3F0] p-2.5 rounded-xl border border-[#CAD7D0] flex items-center gap-2">
                  ...
                  <div className="bg-[#EDF3F0] p-2.5 rounded-xl border border-[#CAD7D0] flex items-center gap-2 col-span-2 sm:col-span-2">
            ...
            <div className="bg-white rounded-3xl p-8 sm:p-10 border border-[#CAD7D0] shadow-[0_12px_40px_rgba(18,38,49,0.06)] flex flex-col justify-between relative overflow-hidden">
              ...
              <div className="mt-8 pt-6 border-t border-[#CAD7D0]/60">
                <div className="grid grid-cols-2 gap-3">
                  <div className="p-3 rounded-xl bg-[#EDF3F0] border border-[#CAD7D0]">
