...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen bg-[#EEF4F3] text-[#122631] pt-28 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden flex items-center justify-center">
          ...
          <div className="lg:col-span-7 bg-white rounded-3xl p-6 sm:p-9 border border-[#CAD7D0] shadow-[0_15px_45px_rgba(18,38,49,0.06)] flex flex-col justify-between">
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="hidden sm:inline-flex items-center gap-1 text-[11px] font-bold text-[#266573] hover:text-[#122631] px-2.5 py-1 rounded-lg bg-[#EEF4F3] border border-[#CAD7D0] transition-colors"
                ...
                <div className="grid grid-cols-2 gap-2 p-1.5 rounded-2xl bg-[#EEF4F3] border border-[#CAD7D0]">
                  <button
                    type="button"
                ...
                <div className="flex items-center justify-between pt-1">
                  ...
                  <div className="inline-flex rounded-lg bg-[#EEF4F3] p-0.5 border border-[#CAD7D0] text-[11px]">
                    <button
                      type="button"
              ...
              {/* ======================================================
                  ...
                  ====================================================== */}
              {isSuccess ? (
                <div className="p-6 rounded-2xl bg-[#EEF4F3] border border-[#266573]/30 text-center space-y-3 animate-in zoom-in-95 duration-200">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full bg-[#EEF4F3]/50 border border-[#CAD7D0] rounded-xl pl-10 pr-4 py-3 text-xs sm:text-sm text-[#122631] placeholder-[#122631]/40 focus:outline-none focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20 transition-all font-medium"
                      />
                    </div>
                  </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          placeholder="••••••••••••"
                          className="w-full bg-[#EEF4F3]/50 border border-[#CAD7D0] rounded-xl pl-10 pr-10 py-3 text-xs sm:text-sm text-[#122631] placeholder-[#122631]/40 focus:outline-none focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20 transition-all font-medium"
                        />
                        <button
                          type="button"
                      ...
                      <div className="flex gap-2">
                        <div className="relative flex-1">
                          ...
                          <input
                            ...
                            disabled={!otpSent}
                            className="w-full bg-[#EEF4F3]/50 border border-[#CAD7D0] rounded-xl pl-10 pr-4 py-3 text-xs sm:text-sm text-[#122631] placeholder-[#122631]/40 focus:outline-none focus:border-[#266573] focus:ring-2 focus:ring-[#266573]/20 transition-all font-mono tracking-widest disabled:opacity-50"
                          />
                        </div>
          ...
          <div className="bg-white rounded-3xl p-6 sm:p-8 max-w-md w-full border border-[#CAD7D0] shadow-2xl space-y-5 animate-in zoom-in-95 duration-200">
            <div className="flex items-center justify-between pb-3 border-b border-[#CAD7D0]/60">
              ...
              <button
                ...
                className="p-1 rounded-lg text-[#122631]/60 hover:text-[#122631] hover:bg-[#EEF4F3]"
              >
                ✕
              </button>
            </div>
            ...
            <div className="space-y-3 text-xs text-[#122631]/80 leading-relaxed">
              ...
              <div className="p-3.5 rounded-2xl bg-[#EEF4F3] border border-[#CAD7D0] space-y-2">
...
export default function LoginPage() {
  return (
    <Suspense
      fallback={
        <div className="min-h-screen bg-[#EEF4F3] flex items-center justify-center">
